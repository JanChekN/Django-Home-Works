...
class Advertisement(models.Model):
    ...
    def created_date(self):
        ...
        if self.created_at.date() == timezone.now().date():
            ...
            return format_html('<span style="color: #9ACD32; font-weight: bold;">Сегодня в {}</span>', created_time)
    ...
    def updated_date(self):
        ...
        if self.updated_at.date() == timezone.now().date():
            ...
            return format_html('<span style="color: #00BFFF; font-weight: bold;">Сегодня в {}</span>', updated_time)
